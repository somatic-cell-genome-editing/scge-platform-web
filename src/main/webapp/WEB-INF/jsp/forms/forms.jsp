...
<style>
    ...
    .forms-container .card:hover {
        box-shadow: 0 4px 16px rgba(0, 0, 0, 0.12);
        transform: translateY(-2px);
    }

    .forms-container .card-header {
        background: #ffffff;
    ...
    .forms-container .card-header h5 {
        color: #003366;
        font-size: 1.1rem;
        font-weight: 600;
        margin: 0;
    ...
    .forms-container .card-header a {
        color: #0066cc;
        margin-left: 10px;
        transition: color 0.2s ease;
    }

    .forms-container .card-header a:hover {
        color: #004499;
    }

    .forms-container .card-body {
        padding: 30px;
        background: #ffffff;
        font-size: 1rem;
        line-height: 1.7;
    ...
    .forms-container .card-body p {
        margin-bottom: 20px;
        text-align: justify;
    }

    /* Lists Styling */
    .forms-container .card-body ul {
        padding-left: 20px;
        margin-bottom: 20px;
    }

    .forms-container .card-body ul li {
        margin-bottom: 15px;
        line-height: 1.8;
    }

    .forms-container .card-body ul li strong {
        color: #003366;
        font-weight: 600;
    }

    /* Links Styling */
    .forms-container .card-body a {
        color: #0066cc;
    ...
    .forms-container .card-body a:hover {
        color: #004499;
        text-decoration: underline;
    }

    /* Button Styling */
    .forms-container .btn-primary {
        background: #0066cc;
        border: none;
        border-radius: 6px;
        padding: 8px 16px;
    ...
    .forms-container .btn-primary:hover {
        background: #004499;
        transform: translateY(-2px);
    ...
    /* Nested Cards */
    .forms-container .card .card {
        margin-top: 25px;
        margin-bottom: 0;
        border: 1px solid #e9ecef;
    }

    .forms-container .card .card .card-header {
        background: #f8f9fa;
    ...
    .forms-container .card .card .card-header h5 {
        color: #495057;
        font-size: 1rem;
        font-weight: 600;
    }

    .forms-container .card .card .card-header a {
        color: #0066cc;
    }
...
<div class="container-fluid forms-container">
    ...
    <div class="row">
        <!-- BEGIN SEARCH RESULT -->
        <div class="col-md-12">
            <div class="grid search forms-grid">
                <div class="grid-body">
                    <div class="row">
                        <!-- BEGIN FILTERS -->
                        <div class="col-md-2">
    ...
    <li>The sponsor's questions involve IND-enabling Chemistry, Manufacturing, and Controls (CMC), pharmacology/toxicology (P/T), and/or clinical trial design issues.</li>
                            ...
                            <div class="card" id="ind-content-format">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul><li><a data-entity-substitution="media_download" data-entity-type="media" data-entity-uuid="0e4d9050-7768-4a55-ac65-f4675d6e16a3" href="https://www.fda.gov/media/123543/download?attachment" title="Investigational New Drug Application (IND)" download>Form FDA 1571: Investigational New Drug Application</a>&nbsp;<a href="/platform/forms_public/FDA-1571_Instructions_R14_03-21-2023 (1).pdf" target="_blank" class="btn-primary btn-sm"><span style="color:whitesmoke">Instructions to fill</span></a>
