        ...
        <div class="col-md-3">
            <div class="sidebar-content">
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <ul>
                        <li>• <a href="/platform/download/regulatory?documentName='PKU Pre-IND briefing book redacted.pdf'">Pre-IND Briefing Book</a></li>
                        <li>• <a href="/platform/download/regulatory?documentName='PKU FDA Preliminary Responses_PS008879_4 redacted.pdf'">Pre-IND Official Responses/Meeting Summary</a></li>
                    </ul>
                </div>
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <ul>
                        <li>• <a href="/platform/download/regulatory?documentName='UCD Pre-IND briefing book redacted.pdf'">Pre-IND Briefing Book</a></li>
                        <li>• <a href="/platform/download/regulatory?documentName='UCD FDA Signed_a_Meeting Summary_PS010343-CHOP redacted.pdf'">Pre-IND Official Responses/Meeting Summary</a></li>
                    </ul>
                </div>
            </div>
        </div>
