...
<div style="margin-bottom: 25px;">
    <h6 style="color: #007bff; text-decoration: underline; font-weight: bold;"><a href="https://scge.mcw.edu/ind-enabling-studies-multiple-disease-platforms/#ahrens-nicklas" target="_blank" style="color: #007bff; text-decoration: underline;">CPS1 Deficiency: Single Patient Expanded Access Program (Multiple Institutions)</a></h6>
<%--    <ul>--%>
