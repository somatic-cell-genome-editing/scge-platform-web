        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <ul class="navbar-nav">
                <li class="nav-item   text-responsive Home" id="Home">
                    <a class="nav-link text-nowrap" href="/platform/loginSuccess?destination=base" style="font-weight: 400;font-size: 16px">
                        <i class="fas fa-tools"></i>&nbsp;Home</a>
                </li>
                <li class="nav-item   text-responsive Studies" id="Studies">
                    <a class="nav-link" href="/platform/data/search/results/Experiment?searchTerm=" >Explore Data <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item   text-responsive Studies" id="Projects">
                    <a class="nav-link" href="/platform/data/search/results/Project?searchTerm=" >Explore Projects <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item  text-responsive" id="Genome Editors">
                    <a class="nav-link" href="/platform/data/search/results/Genome%20Editor?searchTerm=" >Genome Editors <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item  text-responsive" id="Model Systems">
                    <a class="nav-link" href="/platform/data/search/results/Model%20System?searchTerm=" >Model Systems</a>
                </li>
                <li class="nav-item text-responsive" id="Delivery Systems">
                    <a class="nav-link" href="/platform/data/search/results/Delivery%20System?searchTerm=" >Delivery Systems</a>
                </li>
                <li class="nav-item  text-responsive Guides" id="Guides">
                    <a class="nav-link" href="/platform/data/search/results/Guide?searchTerm=" >Guides</a>
                </li>
                <li class="nav-item  text-responsive Vectors" id="Vectors">
                    <a class="nav-link" href="/platform/data/search/results/Vector?searchTerm=" >Vectors</a>
                </li>
                <li class="nav-item  text-responsive Protocols" id="Protocols">
                    <a class="nav-link Protocols" href="/platform/data/search/results/Protocol?searchTerm=" >Protocols</a>
                </li>
                <!--
                <li class="nav-item  text-responsive about" id="about">
                    <a class="nav-link about" href="/platform/data/initiatives" >About SCGE</a>
                </li>
                <li class="nav-item text-nowrap text-responsive Publications" id="Publications">
                    <a class="nav-link Publications" href="/platform/data/publications/search" >Publications</a>
                </li>
                -->
    ...
    <!--li class="nav-item dropdown">
        <div class="btn-group">
            <button type="button" class="btn"><a href="" style="color:#FFFFFF;">About SCGE</a></button>
                ...
                <!--li class="nav-item" style="padding-top: 5px"><a href="/platform/data/dataSubmission"><button type="button" class="btn btn-sm">Upload Docs</button></a>
                </li-->
<!--/c:if-->
