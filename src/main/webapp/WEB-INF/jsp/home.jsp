        ...
        <div class="col-md-6" style="display: table-cell;" >
            <div class="card  flex-md-row mb-4 box-shadow h-100">
                <div class="card-body d-flex flex-column align-items-start">
                    ...
                    <%--                    <h3 class="mb-0">--%>
                    <%--&lt;%&ndash;                        <a class="text-dark" href="#">SCGE Program Background</a>&ndash;%&gt;--%>
                    <%--                    </h3>--%>
                ...
                <%--                <img class="card-img-right flex-auto" src="/platform/images/body-image.png" alt="SCGE Program Background">--%>
            </div>
        </div>
        <div class="col-md-6" style="display: table-cell;">
            <div class="card flex-md-row mb-4 box-shadow h-100">
                <div class="card-body d-flex flex-column align-items-start">
                    ...
                    <%--                    <h3 class="mb-0">--%>
                    <%--&lt;%&ndash;                        <a class="text-dark" href="#">SCGE Phase I</a>&ndash;%&gt;--%>
                    <%--                    </h3>--%>
