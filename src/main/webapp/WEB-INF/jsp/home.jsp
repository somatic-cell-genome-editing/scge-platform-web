...
<%--    <div class="col jumbotron text-white rounded" style="background-color: #dceaf9;padding:0">--%>
<%--        <div class="col" align="center">--%>
<%--            <div style="width: 90%" align="center">--%>
<%--&lt;%&ndash;            <img class="img-fluid" src="/platform/images/platform-overview.png" />&ndash;%&gt;--%>
