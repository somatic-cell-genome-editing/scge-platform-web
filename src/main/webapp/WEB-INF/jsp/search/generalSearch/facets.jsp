...
<h4 class="grid-title"><i class="fa fa-filter"></i> Filters ..&nbsp;<span id="expandAll" class="plus" title="Expand All" onclick="expandAll()" style="cursor: pointer;font-size: medium"><i class="fa-solid fa-circle-plus"></i>&nbsp;Expand All</span><span id="collapseAll" class="minus" style="display: none;color:red;cursor:pointer;font-size: medium" title="Close All" onclick="collapseAll()"><i class="fa-solid fa-circle-minus"></i>&nbsp;Collapse All</span><span style="float:right"><!--button id="clearFilters" class="btn btn-primary btn-sm" onclick="removeFilters()" >Clear</button-->
    ...
    <div id="collapse<%=aggName%>" class="accordion-body collapse" >
      <div class="pl-3  accordion-inner" style="height:auto;max-height: 300px;; overflow-y: auto">
        ...
        <div class="form-check">
          ...
          <label class="form-check-label" for="<%=bktKey%>" data-title="<%=bktKey%>">
            <%=bktKey%>&nbsp;<!--(<%--=bkt.docCount()--%>)-->
          </label>
        </div>
          <%}}%>
