...
<div style="padding-top: 1%">
    ...
    <details>
        ...
        <p>
            ...
            <span style="margin-left: 2%;"><a class="search-results-anchor" href="/platform/data/experiments/study/<%=entry.getKey()%>"><%=entry.getValue()%></a></span>
            <br>
...
<div style="padding-top: 1%">
    ...
    <details>
        ...
        <p>
            ...
            <span style="margin-left: 2%;"><a class="search-results-anchor" href="/platform/data/experiments/experiment/<%=entry.getKey()%>"><%=entry.getValue()%></a></span>
            <br>
