...
<a href="/platform/data/search/results?searchTerm=${searchTerm}"><i class="fa-solid fa-arrow-left"></i>&nbsp;Back to all categories</a>
</c:if>
                        ...
                        <ul class="nav flex-column">
                            <c:forEach items="${agg.value.buckets}" var="bkt">
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link search-results-anchor" href="/platform/data/search/results/${bkt.key}?searchTerm=${searchTerm}" style="padding-left: 0">
...
<c:if test="${fn:length(aggregations.category.buckets)==1}">
    ...
    <c:set var="actionLink" value="/platform/data/search/results/${category}"/>
    <c:if test="${action=='Studies And Experiments'}">
        <c:set var="actionLink" value="/platform/data/search/results/Study/Experiment"/>
    </c:if>
