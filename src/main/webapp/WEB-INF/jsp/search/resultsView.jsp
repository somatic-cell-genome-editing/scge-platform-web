            ...
            <button class="btn btn-light btn-sm" value="all">
                <c:choose>
                    <c:when test="${category!=null}">
                        <a href="/platform/data/search/results/${category}?searchTerm=${searchTerm}">All&nbsp;<i class="fa fa-times-circle" style="font-size:15px;color:red"></i></a>

                    </c:when>
                    <c:otherwise>
                        <a href="/platform/data/search/results?searchTerm=${searchTerm}">All&nbsp;<i class="fa fa-times-circle" style="font-size:15px;color:red"></i></a>
