...
<div class="input-group"><input class="search selectable form-control form-control-sm" type="search" placeholder="Look up in the table" data-column="all"><div class="input-group-append">&nbsp;<span class="input-group-text reset" title="Reset"><i class="fa fa-refresh" aria-hidden="true"></i></span></div></div>
