...
<th class="firstColumn"style="position: sticky;left: 0px;z-index: 3">Trial ID&nbsp;<sup><span data-toggle="tooltip" data-html="true" title="Unique identification code given to each clinical study upon registration at ClinicalTrials.gov" class="column-header-description"></span></sup></th>
...
<th>Last_Update&nbsp;<sup><span data-toggle="tooltip" title="<%=ClinicalTrialsService.facetDefinitions.get("Date of Last Update")%>" class="column-header-description"></span></sup></th>
<%--<th>Std Ages</th>--%>
<th>Eligibility Age&nbsp;<sup><span data-toggle="tooltip" title="<%=ClinicalTrialsService.facetDefinitions.get("Ages Eligible for Study")%>" class="column-header-description"></span></sup></th>
<th>Enrollment Count&nbsp;<sup><span data-toggle="tooltip" title="<%=ClinicalTrialsService.facetDefinitions.get("Trial Enrollment")%>" class="column-header-description"></span></sup></th>
<th>No. of Trial Sites&nbsp;<sup><span data-toggle="tooltip" title="<%=ClinicalTrialsService.facetDefinitions.get("N trial sites")%>" class="column-header-description"></span></sup></th>
