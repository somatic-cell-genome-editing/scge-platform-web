...
<th class="firstColumn"style="position: sticky;left: 0px;">Trial ID&nbsp;<sup><span data-toggle="tooltip" data-html="true" title="Unique identification code given to each clinical study upon registration at ClinicalTrials.gov" class="column-header-description"></span></sup></th>
