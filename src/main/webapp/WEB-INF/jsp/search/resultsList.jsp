        ...
        <div>
            <div>
                ...
                <small>
                    ...
                    <!--a href="https://reporter.nih.gov/project-details/$-{hit.sourceAsMap.currentGrantNumber}" target="_blank"><img src="/platform/images/nihReport.png" alt="NIH Report" > </a-->
                    <a href="<%=hit.get("nihReporterLink")%>" target="_blank"><img src="/platform/images/nihReport.png" alt="NIH Report" > </a>
