...
public class LoginController extends ModulesController{
    ...
    ClinicalTrialsService clinicalTrialsService = new ClinicalTrialsService();

    @RequestMapping("home")
    public String getHomePage(HttpServletRequest req) throws Exception {
        ...
        // Get daily digest count for home page (active records only)
        try {
